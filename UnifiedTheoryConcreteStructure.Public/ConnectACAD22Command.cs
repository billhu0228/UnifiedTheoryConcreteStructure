...
{
    public class ConnectACAD22Command : ICommand
    {
        #region Fields
        ...
        public ConnectACAD22Command(Action<object> execute)
        ...
        public ConnectACAD22Command(Action<object> execute, Predicate<object> canExecute)
        {
            if (execute == null)
            {
